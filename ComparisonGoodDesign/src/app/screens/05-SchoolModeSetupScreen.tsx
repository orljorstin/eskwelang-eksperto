...
import { GraduationCap, Gamepad2, Clock, CheckCircle } from 'lucide-react';
          ...
          <div className="space-y-4">
            ...
            {children.map((child) => (
              <button
                ...
                className={`w-full p-5 rounded-xl border-3 transition-all flex items-center gap-4 ${
            ...
            <div className="grid grid-cols-2 gap-3">
              {durations.map((duration) => (
                <button
                  ...
                  className={`h-16 rounded-xl border-3 transition-all flex items-center justify-center gap-2 ${
                ...
                >
                  <Clock className={`w-5 h-5 ${
                    selectedDuration === duration.value ? 'text-teal-600' : 'text-gray-400'
                  }`} />
                  <span className={`text-lg font-semibold ${
                    selectedDuration === duration.value ? 'text-teal-900' : 'text-gray-700'
                  }`}>
                    {duration.label}
                  </span>
                </button>
