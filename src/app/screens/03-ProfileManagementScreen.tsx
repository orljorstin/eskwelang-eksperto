    ...
    <div className="h-full bg-gray-50 flex flex-col relative">
      ...
      <div className="px-6 py-4 bg-gray-900 text-white relative overflow-hidden flex items-center gap-3 border-b border-gray-800">
        ...
        <div className="relative z-10 flex items-center gap-3 w-full">
          <button onClick={() => navigate('/dashboard')} className="p-2 -ml-2 hover:bg-white/10 rounded-full transition-colors">
            <ArrowLeft className="w-6 h-6 text-gray-400 hover:text-white" />
          </button>
          <div>
            <h1 className="text-2xl font-bold text-white">{t('profilesTitle')}</h1>
            <p className="text-sm text-gray-400 mt-1">{t('manageProfilesSubtitle')}</p>
          </div>
        </div>
      </div>
